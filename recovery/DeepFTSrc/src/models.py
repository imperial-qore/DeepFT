...
class DeepFT_simulator_16(nn.Module):
	def __init__(self):
		super(DeepFT_simulator_16, self).__init__()
		self.name = 'DeepFT_simulator_16'
		self.lr = 0.0008
		self.n_hosts = 16
...
## Simple Multi-Head Self-Attention Model
class DeepFT_framework_16(nn.Module):
	def __init__(self):
		super(DeepFT_framework_16, self).__init__()
		self.name = 'DeepFT_framework_16'
		self.lr = 0.0008
		self.n_hosts = 16
		self.n_feats = 3 * self.n_hosts
		self.n_window = 1 # w_size = 3
